...
// #define CONFIG_EXAMPLE_A2DP_SINK_OUTPUT_INTERNAL_DAC
...
// xTaskCreate(start_bluetooth, "Bluetooth initializer", 4096, NULL, 1, &start_bluetooth_hdl);
...
//     ESP_LOGE(BT_AV_TAG, "BT_NAME_in main %s", bt_name_by_user);
